...
from utiliites_scripts.proposals import gen_ikeprop_config
...
class IkeProposalManager:
    ...
    def get_proposals(self, interactive=False, retries=3):
        attempt = 0
            ...
            try:
                ...
                if response:
                    for _, result in response.items():
                        ...
                        if ike_config:
                            ike_proposal_names = ike_config['proposal'].get('name')
